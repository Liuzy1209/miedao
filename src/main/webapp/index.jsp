...
<!-- 我是邪恶的分割线 -->
	<section>
		<div class="cake">
			<div class="cake-img">
				<img src="static/image/index/cake.png" alt="">
			</div>
			<div class="cake-font">
				<div>
					<img src="static/image/index/about-us.png" alt="">
				</div>
		...
		<div class="show-case-img-box">
			<div class="img">
				...
				<a href=""><img src="static/image/index/index-1.png" alt=""></a>
			</div>
			<div class="img">
				<div class="img-mask">
					阳光
				</div>
				<a href=""><img src="static/image/index/index-2.jpeg" alt=""></a>
			</div>
			<div class="img">
				<div class="img-mask">
					甜蜜
				</div>
				<a href=""><img src="static/image/index/index-3.jpg" alt=""></a>
			</div>
		</div>
		<div class="show-case-img-box">
			<div class="img">
				...
				<a href=""><img src="static/image/index/index-4.jpg" alt=""></a>
			</div>
			<div class="img">
				<div class="img-mask">
					蜜恋
				</div>
				<a href=""><img src="static/image/index/index-5.jpg" alt=""></a>
			</div>
			<div class="img">
				<div class="img-mask">
					田园
				</div>
				<a href=""><img src="static/image/index/index-6.jpeg" alt=""></a>
			</div>
		</div>
		<div class="show-case">
			<div class="show-banner">
		...
		<div class="show-case-img-box">
			<div class="img">
				...
				<img src="static/image/index/sale-1.png" alt="">
			</div>
			<div class="img">
				<div class="img-mask">
					少女甜甜圈
				...
				<img src="static/image/index/index-3.jpg" alt="">
			</div>
		</div>
		<div class="show-case-img-box">
			<div class="img">
				...
				<img src="static/image/index/index-4.jpg" alt="">
			</div>
			<div class="img">
				<div class="img-mask">
					流心蜜枣
				...
				<img src="static/image/index/index-5.jpg" alt="">
			</div>
			<div class="img">
				<div class="img-mask">
					风味青稞
				...
				<img src="static/image/index/index-6.jpeg" alt="">
			</div>
		</div>
		<!--  -->
		<div class="show-case">
		...
		<div class="show-case-img-box">
			<div class="img">
				<div class="info-top">
					<img src="static/image/index/infomation-top.png" alt="">
				</div>
				<a href=""><img src="static/image/index/index-4.jpg" alt=""></a>
			</div>
			<div class="img">
				...
				<div class="info-bottom">
					<img src="static/image/index/infomation-bottom.png" alt="">
				</div>
			</div>
			<div class="img">
				<div class="info-top">
		...
		<div class="show-case-img-box">
			<div class="img">
				...
				<img src="static/image/index/seation_02.png" alt="">
			</div>
			<div class="img">
				<div class="img-mask img-mask-season">
					一只大蒜
				</div>
				<img src="static/image/index/seation_03.png" alt="">
			</div>
			<div class="img">
				<div class="img-mask img-mask-season">
					一些干果
				</div>
				<img src="static/image/index/seation_05.png" alt="">
			</div>
			<div class="img">
				<div class="img-mask img-mask-season">
					一扇排骨
				</div>
				<img src="static/image/index/seation_06.png" alt="">
			</div>
		</div>
		<div class="show-case-img-box">
			<div class="img">
				...
				<img src="static/image/index/seation_09.png" alt="">
			</div>
			<div class="img">
				<div class="img-mask img-mask-season">
					一些山货
				</div>
				<img src="static/image/index/seation_08.png" alt="">
			</div>
			<div class="img">
				<div class="img-mask img-mask-season">
					一些甜点
				</div>
				<img src="static/image/index/seation_07.png" alt="">
			</div>
			<div class="img">
				<div class="img-mask img-mask-season">
					还是咸鱼
		...
		<div class="show-case-img-box">
			<div class="img">
				<img src="static/image/index/appeal-banner.png" alt="">
			</div>
		</div>
		<div class="show-case">
			<div class="show-banner">
		...
		<div class="show-case-info-box">
			<div class="service-info">
				<img src="static/image/index/service1.png" alt="">
				<h3>严选食材</h3>
				<p>食不厌精，脍不厌细。我们执着于对吃的品质追求，良材是美味的奠定。这是唇齿间的感官满足，也是由心使然的美食哲学。</p>
			</div>
			<div class="service-info">
				<img src="static/image/index/service2.png" alt="">
				<h3>名厨主理</h3>
				<p>五味调和，鲜之有道，味蕾的愉悦是最原始的欲望满足。极致的美味体验不是凭空而来，所有的呈现都源于对美食的执念与热爱。</p>
			</div>
			<div class="service-info">
				<img src="static/image/index/service3.png" alt="">
				<h3>均衡营养</h3>
		...
		<div class="show-case-info-box">
			<div class="service-info">
				<img src="static/image/index/service4.png" alt="">
				<h3>全程冷链</h3>
				<p>从源头到终端，全程冷链锁定食材的营养与鲜度，保证最赏味期。智能化中央厨房，高标准、极新鲜、超健康，满足餐品更高品质。</p>
			</div>
			<div class="service-info">
				<img src="static/image/index/service5.png" alt="">
				<h3>终端自助</h3>
				<p>全网联控，不同终端满足不同场景的美食需求；智能互联，自动化集成办公，品质全程可追溯，健康大数据，给你更细致入微的关怀。</p>
			</div>
			<div class="service-info">
				<img src="static/image/index/service6.png" alt="">
				<h3>智能互联</h3>
